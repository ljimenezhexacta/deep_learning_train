...
### 2.2. Ventajas y desafíos del Deep Learning
...
### 2.3. Más Aplicaciones del Deep Learning
...
### 11.1. API Keras
Exploraremos la API Keras, una herramienta de alto nivel que facilita la construcción de redes neuronales.

### 11.2. Backends populares
Nos adentraremos en los backends más utilizados para el desarrollo de redes neuronales. Exploraremos las características y ventajas de frameworks como TensorFlow, PyTorch, Theano y CNTK, que ofrecen un conjunto de herramientas poderosas para el procesamiento de redes neuronales.
